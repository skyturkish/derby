...
extension DurationExtension on BuildContext {
  Duration get smallDuration => const Duration(milliseconds: 500);
  Duration get mediumDuration => const Duration(seconds: 1);
  Duration get largeDuration => const Duration(milliseconds: 1500);
  Duration get largeXDuration => const Duration(seconds: 2);
}
